...
\degreedate{September, 2019}                        % when did you submit -- officially after your corrections !
...
\mainmatter 
    ...
    \input{chap3/PMLSM_design_with_HM_techniques}
    \input{chap4/PMLSM_design_with_RSM_techniques}
    \input{chap5/experimental_realization}
    \input{chap6/conclusions}
    \appendix
